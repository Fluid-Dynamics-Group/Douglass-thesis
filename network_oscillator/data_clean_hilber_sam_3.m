...
[z_amp_1, z_amp_1_test] = TestTrainSplit(z_amp_1, p_split);
[z_amp_2, z_amp_2_test] = TestTrainSplit(z_amp_2, p_split);
[z_dot_amp_1, z_dot_amp_1_test] = TestTrainSplit(z_dot_amp_1, p_split);
[z_dot_amp_2, z_dot_amp_2_test] = TestTrainSplit(z_dot_amp_2, p_split);

z_test     = [z_amp_1_test; z_amp_2_test];
z_dot_test = [z_dot_amp_1_test; z_dot_amp_2_test];

z_train_all     = [z_amp_1; z_amp_2];
z_dot_train_all = [z_dot_amp_1; z_dot_amp_2];


save('data_full_sam_phase.mat', 'z_dot_amp_1', 'z_dot_amp_2', 'z_amp_1', 'z_amp_2', 'z_dot_test', 'z_test', 'z_train_all', 'z_dot_train_all')
