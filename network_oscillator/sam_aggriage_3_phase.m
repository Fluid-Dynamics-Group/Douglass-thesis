...
% Load data
% ------------------------------------------------------------------
load data_full_sam_combined.mat;   % zprime_norm_amp_1 zprime_norm_dot_amp_1 54900x4
...
print('-depsc','aggregate_network_error.eps');
% Legend Plotting
% ylim([0 10]);
% set(gca,'Fontsize',16);
...
plotting_adjacency_new1(abs(Areg),7,1);caxis([0 5]);
